...
type
  ...
  Tbson_append_bool = function (b: Pointer; Name: PAnsiChar; Value: WordBool): Integer; cdecl; 
  ...
  Tbson_iterator_bool = function (i: Pointer): WordBool; cdecl; 
...
function bson_append_bool(b: Pointer; Name: PAnsiChar; Value: WordBool): Integer; cdecl; external MONGOC_DLL;
...
function bson_iterator_bool(i: Pointer): WordBool; cdecl; external MONGOC_DLL;
